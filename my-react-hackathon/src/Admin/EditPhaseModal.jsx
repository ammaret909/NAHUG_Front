                    ...
                    <div className="d-flex row justify-content-center border-0 ">
                        ...
                        <form className="card-deck col-12 row justify-content-start mt-2 mb-3 " onSubmit={onSubmit}>
                            ...
                            <div className="d-flex justify-content-center mb-3">
                                ...
                                <button type="button" className="btn-or2 p-2 m-2 d-flex col-4 m-buttom justify-content-center fw-bold rounded-3" onClick={propSimulator.onHide}>Cancel</button>
                            </div>
