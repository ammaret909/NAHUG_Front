...
function AddFormModal({ show, onHide, token, brandId }) {
                ...
                <Modal.Body className="border-0 bg-h-orange2 rounded-bottom">
                    <div className="d-flex row justify-content-center border-0 ">
                        <div className="pt-3 text-back t-text d-flex justify-content-center align-items-center ">
                            <label for="" className="">ADD FORMULAR</label>
                        </div>
                        ...
                        <form className="card-deck col-12 row d-flex justify-content-center mt-2 mb-3 bg-h-orange2" onSubmit={onSubmit}>
                            ...
                            {
                                image ?
                                    <label for="fileImgAddForm" className="d-flex justify-content-center bg-h-smoke col-8 col-sm-8 c-one rounded p-2 mb-3 align-items-center">
                            ...
                            <div>
                                <input type="file" name="file" id="fileImgAddForm" ref={inputFileRef} onChange={handleChange}></input>
                            </div>
