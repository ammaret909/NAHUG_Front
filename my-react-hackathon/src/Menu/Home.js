                        ...
                        <div className="d-flex justify-content-center row ">
                            {
                                cats.map((cat) =>
                                    <Link to="/profile" state={{ catId: cat._id }} className="row bg-h-orange p-4 mb-4 rounded-pill shadow text-decoration-none">
                                        ...
                                        <Link to="/food" className="d-flex justify-content-md-end  justify-content-center col-6 col-sm-6 col-md-2 align-items-center rounded-circle mt-1 ">
                                            <img src="image/catfood1.png" className="d-flex icon-s2 rounded-circle bg-h-egg btn-wh" alt="logo2.png"></img>
                                        </Link>
                                        <Link to="/addcat" className="d-flex justify-content-md-end  justify-content-center col-6 col-sm-6 col-md-2 align-items-center rounded-circle mt-1">
